         ...
         <form action="" method="POST">
            ...
            <div class="gender">
               <select id="gender" name="gender">
                  ...
                  <option value="other" <?php if ($rows['gender'] == "other") {
                                             echo "selected";
                                          } ?>>Other</option>
               </select>
            </div>
            <div class="blood_group">
               <select id="blood_group" name="blood_group" class="form-select">
                  ...
                  <option value="A+" <?php if ($rows['blood_group'] == "A+") {
                                          echo "selected";
                                       } ?>>A+</option>
                  <option value="A-" <?php if ($rows['blood_group'] == "A-") {
                                          echo "selected";
                                       } ?>>A-</option>
                  <option value="B+" <?php if ($rows['blood_group'] == "B+") {
                                          echo "selected";
                                       } ?>>B+</option>
                  <option value="B-" <?php if ($rows['blood_group'] == "B-") {
                                          echo "selected";
                                       } ?>>B-</option>
                  <option value="AB+" <?php if ($rows['blood_group'] == "AB+") {
                                          echo "selected";
                                       } ?>>AB+</option>
                  <option value="AB-" <?php if ($rows['blood_group'] == "AB-") {
                                          echo "selected";
                                       } ?>>AB-</option>
                  <option value="O+" <?php if ($rows['blood_group'] == "O+") {
                                          echo "selected";
                                       } ?>>O+</option>
                  <option value="O-" <?php if ($rows['blood_group'] == "O-") {
                                          echo "selected";
            ...
            <div class="district">
               <select id="district" name="district">
                  ...
                  <option value="Dhaka" <?php if ($rows['district'] == "Dhaka") {
                                             echo "selected";
                                          } ?>> Dhaka</option>
                  <option value="Chittagong" <?php if ($rows['district'] == "Chittagong") {
                                                echo "selected";
                                             } ?>>Chittagong</option>
                  <option value="Sylhet" <?php if ($rows['district'] == "Sylhet") {
                                             echo "selected";
                                          } ?>>Sylhet</option>
                  <option value="Barishal" <?php if ($rows['district'] == "Barishal") {
                                                echo "selected";
                                             } ?>>Barishal</option>
                  <option value="Bogra" <?php if ($rows['district'] == "Bogra") {
                                             echo "selected";
                                          } ?>>Bogra</option>
                  <option value="Comilla" <?php if ($rows['district'] == "Comilla") {
                                             echo "selected";
                                          } ?>>Comilla</option>
                  <option value="Shariatpur" <?php if ($rows['district'] == "Shariatpur") {
                                                echo "selected";
                                             } ?>>Shariatpur</option>
                  <option value="Madaripur" <?php if ($rows['district'] == "Madaripur") {
                                                echo "selected";
                                             } ?>>Madaripur</option>
