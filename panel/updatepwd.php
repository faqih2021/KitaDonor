    ...
    if (isset($_POST['update_pwd'])) {
        ...
        if (empty($password) || empty($new_password) || empty($confirm_password)) {
            ...
            if ($new_password != $confirm_password) {
                ...
                $sql    = "UPDATE users SET `password`='$new_password' where email='$email' and password ='$password' ";
...
<body>
    <div class="topnav">
        ...
        <li><a href="login.php" style="margin-left: 500px;"><?php if (isset($_COOKIE['user'])) {
                                                                echo "<form action=\"\" method=\"post\"> <button type=\"submit\" name=\"logout\" class=\"navbutton\">Logout</button>
            </form>";
                                                            } else {
                                                                echo "Login";
                                                            } ?></a></li>
    ...
    <div class="panelhome" style="height: 500px;">
        ...
        <div class="updatepwd">
            ...
            <form action="" method="post">
                ...
                <input type="password" placeholder="Current Password" name="curr_pwd" class="password" required><br>
                <input type="password" placeholder="New Password" name="pwd1" class="password" required><br>
                <input type="password" placeholder="Confirm New Password" name="pwd2" class="password" required><br>
