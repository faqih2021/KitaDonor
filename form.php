...
<head>
    <title>Contact Donor | Rokto</title>
...
<div class="contact_form">
    ...
    <form action="" method="post">
        <input type="text" name="name" placeholder="Your Name"  <?php if (isset($_COOKIE['user'])) {
    echo "value=\"" . $rows['first_name'] . ' ' . $rows['last_name'] . "\"";
}
?> required><br>
        <input type="email" name="email" placeholder="Enter Your Email" <?php if (isset($_COOKIE['user'])) {
    echo "value=\"" . $rows['email'] . "\"";
}
?> required><br>
        <input type="mobile" name="mobile" placeholder=" >Your Mobile" <?php if (isset($_COOKIE['user'])) {
    echo "value=\"" . $rows['phone'] . "\"";
}
?> required><br>
        <textarea type="text" name="message" placeholder="Your Massage" required></textarea><br>
